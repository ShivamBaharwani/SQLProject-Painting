...
-- Since every museum have painting therefore the output of this query will be empty

/*2) How many paintings have an asking price of more than their regular price?*/
select count(*) as total
from product_size
WHERE sale_price > regular_price;
-- not a single painting's ask price is more than their regular price
...
-- 58 paintings ask price is less than 50% of its regular price
...
/*11) Which museum is open for the longest during a day. Dispay museum name, state and hours open and which day?*/
...
/*14) A Which country has the 5th highest no of paintings?*/
...
/*15) A Which are the 3 most popular and 3 least popular painting styles?*/
...
/*16)A Which artist has the most no of Portraits paintings outside USA?. Display artist name, no of paintings and the artist nationality.*/
